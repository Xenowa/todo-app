...
function toggleTodo(cardId, todoId, done) {
  ...
  if (cardEl) {
    ...
    cardEl.querySelector('.card-progress-text').textContent = progress + '% complete'
    cardEl.querySelector('.card-count').textContent = `${doneCount}/${totalCount}`
...
// Open card modal
btnAddCard.addEventListener('click', () => openModal(modalCard, cardTitleInput))
btnAddCardEmpty.addEventListener('click', () => openModal(modalCard, cardTitleInput))

// Close card modal
modalCardClose.addEventListener('click', () => closeModal(modalCard, cardTitleInput))
modalCardCancel.addEventListener('click', () => closeModal(modalCard, cardTitleInput))
...
modalCardConfirm.addEventListener('click', () => {
  ...
  if (!val) { cardTitleInput.focus(); return }
  addCard(val)
...
// Close todo modal
modalTodoClose.addEventListener('click', () => closeModal(modalTodo, todoTextInput))
modalTodoCancel.addEventListener('click', () => closeModal(modalTodo, todoTextInput))
...
modalTodoConfirm.addEventListener('click', () => {
  ...
  if (!val) { todoTextInput.focus(); return }
...
document.addEventListener('keydown', e => {
  ...
  if (modalCard.classList.contains('open')) closeModal(modalCard, cardTitleInput)
  if (modalTodo.classList.contains('open')) closeModal(modalTodo, todoTextInput)
})
